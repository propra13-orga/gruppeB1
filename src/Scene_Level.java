...
public class Scene_Level extends Abstract_Scene {
	...
	private void BeispielInit() {
		...
		String bla = "Sie hatten uns mit Zwang und L�gen in ihre St�cke eingeschraubt. Sie "+
		"hatten gn�dig uns erlaubt, in ihrem Joch ihr Land zu pfl�gen. Sie sa�en da in Prunk und "+
				"Pracht mit vollgestopftem Magen und zwangen uns, f�r ihre Macht einander totzuschlagen. "+
