 ...
 * (lowmap und highmap) zusammen. Da das Tileset fï¿½r jedes Tile speichert, ob das Tile begehbar
 * ist oder nicht, bietet die Map eine vereinfachte Schnittstelle, die prï¿½ft, ob das abgefragte
 * Feld auf der Map begehbar ist (wird in Scene_Map beim Steuern der Spielfigur genutzt).
 * 
 * Die Methode getLowMapImage() zeichnet ein BufferedImage, welches den Teil der Karte enthï¿½lt,
...
>>>>>>> 85c8cee54e8b7f323cca4d4494bfbc1927ca60ca
	...
	private int getTileID(int layer, int x, int y) {
		//Gibt die ID eines Tiles im jeweiligen Layer des Tilesets zurï¿½ck
